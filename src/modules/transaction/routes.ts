...
import { getTxnStatus, validateChecksum } from "../../utils/helper";
...
export function configureRoutes(server: FastifyInstance, options: any, done: any): void {
    ...
    const getTransaction = async (request: FastifyRequest<{ Body: RequestBody }>, reply: FastifyReply) => {
        ...
        //     checksum: null
        // });
        reply.code(200).send({"Helllo":"weather"});
    }
